...
io.on("connection", (socket) => {
  socket.on("sendMessage", async (data) => {
    ...
    try {
      ...
      const response = await axios.post("https://chatbot-backend-zocs.onrender.com/getResponse", {
      ...
      const updatedChats = await axios.post("https://chatbot-backend-zocs.onrender.com/chat/addChat", {
        newchats
      })
